...
folder are mapped to the application's root namespace, 'BaseSimple'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "BaseSimple"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'BaseSimple' in the same way
as `"BaseSimple/sass/src"`.
